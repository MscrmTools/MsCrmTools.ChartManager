...
{
    public partial class MainControl : PluginControlBase, IHelpPlugin, IGitHubPlugin
    {
        private string currentFolder;
        private ListViewItem[] listViewItemsCache;

        public string HelpUrl => "https://github.com/MscrmTools/MsCrmTools.ChartManager/wiki";
        public string RepositoryName => "MsCrmTools.ChartManager";
